...
export default function ClientService({ data }: { data: any }) {
    ...
    const handleImageClick = () => {
        window.open('https://docs.google.com/forms/d/e/1FAIpQLSejNipXayxNXdwW43QYYu51Z3bQXXSon3CdR_YSYnEhjq1IVw/viewform', '_blank');
    }

    return (
        <div className="bg-[#5A95F5] text-center h-screen w-full flex flex-col items-center justify-center">
            {/* Top Section: Contains titles */}
            <div className="flex-1 flex flex-col w-full items-center justify-end text-white mt-20">
            ...
            {/* Button Section */}
            <div className="flex-1 flex flex-col w-full items-center justify-start mt-10">
